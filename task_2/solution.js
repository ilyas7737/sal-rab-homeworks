function calcShipping(sum, min, shipping) {
    ...
    shippingSum = productsSum == 0;

    // если productsSum Больше или равна freeShippingMinSum,
    // то shippingSum присвоить значение 0
    shippingSum = productsSum >= freeShippingMinSum ==0;

    // если productsSum больше 0 и меньше freeShippingMinSum,
    // то shippingSum присвоить значение shippingPrice
    shippingSum = productsSum > 0 == shippingPrice;
    shippingSum = productsSum < freeShippingMinSum == shippingPrice;
...
function calcDiscount(sum, min, discount) {
    ...
    discountSum = productsSum >= discountMinSum == ??????
